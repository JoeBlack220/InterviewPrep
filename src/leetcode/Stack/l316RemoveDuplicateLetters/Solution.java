package leetcode.Stack.l316RemoveDuplicateLetters;
...
public class Solution {
    public String removeDuplicateLetters(String s) {
        ...
        for(char c : ch){
            ...
            // we do pop out when the previous letter is bigger in lexical order than the current one
            // and the previous letter isn't the last one of that character
