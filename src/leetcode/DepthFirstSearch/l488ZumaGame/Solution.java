package leetcode.DepthFirstSearch.l488ZumaGame;

public class Solution {
    int MAXCOUNT = 6;   // the max balls you need will not exceed 6 since "The number of balls in your hand won't exceed 5"
    // brute force dfs, try to eliminate every block of same color balls
    // return the smallest number of balls that are used
