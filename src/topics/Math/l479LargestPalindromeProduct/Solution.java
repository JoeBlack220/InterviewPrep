package topics.Math.l479LargestPalindromeProduct;

public class Solution {
    // construct the palindrome we can get one by one, then test whether it can be represents by the multiplication
    // of two numbers of digit n
