package topics.TreeMap.l497RandomPointinNonoverlappingRectangles;
import java.util.*;
// we need the larger rectangles has bigger possibility to be chosen
// so we can use how many points / how big the area is of a rectangle as weight
